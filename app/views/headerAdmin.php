...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="<?= RACINE_SITE ?>public/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?= RACINE_SITE ?>public/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?= RACINE_SITE ?>public/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?= RACINE_SITE ?>public/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?= RACINE_SITE ?>public/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?= RACINE_SITE ?>public/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="<?= RACINE_SITE ?>public/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?= RACINE_SITE ?>public/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?= RACINE_SITE ?>public/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="36x36" href="<?= RACINE_SITE ?>public/android-icon-36x36.png">
    <link rel="icon" type="image/png" sizes="48x48" href="<?= RACINE_SITE ?>public/android-icon-48x48.png">
    <link rel="icon" type="image/png" sizes="72x72" href="<?= RACINE_SITE ?>public/android-icon-72x72.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?= RACINE_SITE ?>public/android-icon-96x96.png">
    <link rel="icon" type="image/png" sizes="144x144" href="<?= RACINE_SITE ?>public/android-icon-144x144.png">
    <link rel="icon" type="image/png" sizes="192x192" href="<?= RACINE_SITE ?>public/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?= RACINE_SITE ?>public/favicon-96x96.png">
    <link rel="manifest" href="<?= RACINE_SITE ?>public/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?= RACINE_SITE ?>public/ms-icon-144x144.png">
