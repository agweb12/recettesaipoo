...
<header>
    ...
    <nav class="menu">
        <a href="<?= RACINE_SITE ?>views/admin/dashboard.php" class="imgMenu"><img src="<?= RACINE_SITE ?>/public/assets/img/logo-white.webp" alt="Logo Recette AI"></a>
        <div class="ctaButtons">
            <button id="theme-toggle" class="theme-toggle" aria-label="Basculer entre mode clair et sombre">
                <i class="fi fi-sr-moon"></i>
            </button>
            <?php if (isAdminLoggedIn()): ?>
                <a href="<?= RACINE_SITE ?>?action=deconnexionAdmin" class="cta"><i class="fi fi-sr-sign-out-alt"></i> Déconnexion</a>
                <a href="<?= RACINE_SITE ?>views/admin/dashboard.php" class="<?= is_active('dashboard.php') ? 'active' : '' ?>"><i class="fi fi-sr-user-gear"></i> Dashboard</a>
            <?php else: ?>
                <a href="<?= RACINE_SITE ?>views/admin/inscription.php" class="cta<?= is_active('inscription.php') ? ' active' : '' ?>"><i class="fi fi-sr-sign-up"></i> S'inscrire</a>
                <a href="<?= RACINE_SITE ?>views/admin/connexion.php" class="cta<?= is_active('connexion.php') ? ' active' : '' ?>"<i class="fi fi-sr-enter"></i> Se Connecter</a>
            <?php endif; ?>
        </div>
    </nav>
</header>
