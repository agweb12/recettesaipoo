...
$router->add('admin/login', '\App\Controllers\AdminAuthController', 'login');
...
$router->add('admin/categories/create', '\App\Controllers\AdminCategoriesController', 'create');
$router->add('admin/categories/store', '\App\Controllers\AdminCategoriesController', 'store', 'POST');
$router->add('admin/categories/edit/([0-9]+)', '\App\Controllers\AdminCategoriesController', 'edit');
...
$router->add('admin/etiquettes/edit/([0-9]+)', '\App\Controllers\AdminEtiquettesController', 'edit');
...
$router->add('admin/unites-mesure/edit/([0-9]+)', '\App\Controllers\AdminUnitesMesureController', 'edit');
...
$router->add('admin/ingredients/edit/([0-9]+)', '\App\Controllers\AdminIngredientsController', 'edit');
...
$router->add('admin/recettes/edit/([0-9]+)', '\App\Controllers\AdminRecettesController', 'edit');
...
$router->add('admin/utilisateurs/edit/([0-9]+)', '\App\Controllers\AdminUtilisateursController', 'edit');
...
$router->add('admin/administrateurs/create', '\App\Controllers\AdminAdministrateursController', 'create');
$router->add('admin/administrateurs/store', '\App\Controllers\AdminAdministrateursController', 'store', 'POST');
$router->add('admin/administrateurs/edit/([0-9]+)', '\App\Controllers\AdminAdministrateursController', 'edit');
